...
LDFLAGS = -L. -lmemory_manager -pthread -lm  # Ensure math library is linked with -lm
...
test_list: $(LIB_NAME) linked_list.o
	$(CC) $(CFLAGS) -o test_linked_list linked_list.c test_linked_list.c -L. -lmemory_manager -pthread -lm
